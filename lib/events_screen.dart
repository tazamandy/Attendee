...
class QrCodeScreen extends StatelessWidget {
  ...
  String? _getQrCodeData(dynamic user) {
    ...
    try {
      ...
      // Try different property names for QR code data
      return dynamicUser.qrCodeData?.toString() ?? 
             ...
             dynamicUser.qrImage?.toString() ??
             dynamicUser.qr_image?.toString();
    } catch (e) {
      return null;
    }
  }
  ...
  String _getStudentId(dynamic user) {
    ...
    try {
      ...
      // Try different property names for student ID
  ...
  String _getCourse(dynamic user) {
    ...
    try {
      ...
      // Try different property names for course
