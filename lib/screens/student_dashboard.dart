  ...
  Widget _buildQuickActionsSection(BuildContext context, dynamic user, String studentId) {
    return Column(
      ...
      children: [
        ...
        _buildActionRow([
          _ActionData('QR Code', Icons.qr_code_2_rounded, const Color(0xFF007AFF), () {
            QRCodeDialog.show(context, user: user, studentId: studentId);
          }),
          _ActionData('Attendance', Icons.calendar_today_rounded, const Color(0xFF34C759), () {}),
        ]),
        const SizedBox(height: 12),
        _buildActionRow([
          _ActionData('Schedule', Icons.schedule_rounded, const Color(0xFFFF9500), () {}),
          _ActionData('Profile', Icons.person_rounded, const Color(0xFFFF2D55), () {}),
        ]),
      ],
    );
  }

  Widget _buildActionRow(List<_ActionData> actions) {
    return Row(
